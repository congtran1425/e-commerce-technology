  ...
  return (
    <article className="story-page page-frame">
      <header className="story-letter">
        <p className="story-letter__date">Lời chào từ Một Mẻ Bánh</p>
        <h1>Chào bạn,</h1>
      ...
      <section className="story-prose" aria-labelledby="story-problem-heading">
        <h2 id="story-problem-heading">Một Mẻ Bánh bắt đầu từ món bạn muốn làm.</h2>
        <p>Thay vì đưa bạn đến trước một kệ hàng thật dài, chúng tôi bắt đầu bằng một câu hỏi gần gũi hơn: hôm nay bạn muốn làm món bánh nào? Từ món bánh và số người cùng ăn, Một Mẻ Bánh giúp tính lại định lượng, chỉ ra dụng cụ cần có và ghép chúng với những quy cách đang bán.</p>
      ...
      <section className="story-prose" aria-labelledby="story-enough-heading">
        <h2 id="story-enough-heading">Mỗi mẻ bánh có một cách chuẩn bị riêng.</h2>
        <p>Một mẻ bánh cần bao nhiêu nguyên liệu, gói hàng nào phù hợp và sau khi làm có thể còn dư gì? Dụng cụ nào bắt buộc, dụng cụ nào chỉ giúp thao tác thuận tiện hơn? Chúng tôi muốn những câu trả lời ấy được trình bày rõ ràng để người mới không bị ngợp và người đã quen làm bánh không phải mất công tính lại.</p>
      ...
      <section className="story-prose" aria-labelledby="story-honesty-heading">
        ...
        <p>Một Mẻ Bánh không hứa rằng mọi mẻ bánh sẽ hoàn hảo ngay lần đầu. Nhiệt của mỗi chiếc lò, độ ẩm của bột và kinh nghiệm của mỗi người đều khác nhau. Vì vậy, công thức phải có dấu hiệu nhận biết bên cạnh thời gian và nhiệt độ; phần nào chưa được kiểm chứng sẽ được ghi rõ thay vì lấp đầy bằng một con số có vẻ thuyết phục.</p>
      ...
      <footer className="story-signoff">
        <p>Chọn món bạn muốn làm. Một Mẻ Bánh giúp bạn chuẩn bị từng phần cho mẻ bánh ấy.</p>
