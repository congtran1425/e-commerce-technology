...
| Mức | Ý nghĩa | Cho phép hiển thị |
| --- | --- | --- |
| Giữ có điều kiện | Cấu trúc hợp lý, cần bổ sung chi tiết và thử bếp | Có thể làm bản nháp, phải gắn nhãn chưa kiểm chứng |
| Cần sửa | Có mâu thuẫn hoặc thiếu dữ liệu ảnh hưởng rõ đến kết quả | Không cho tạo giỏ từ công thức trước khi sửa |
| Chưa xuất bản | Rủi ro kỹ thuật, an toàn hoặc tên gọi quá lớn | Ẩn khỏi danh mục công khai cho đến khi có bản mới |

## Bảng rà soát 12 món

| Món | Nguồn đối chiếu chính | Đánh giá hiện tại | Việc cần làm trước khi xuất bản |
| --- | --- | --- | --- |
...
| Tiramisu | Le Beccherie | Chưa xuất bản | Chọn “nguyên bản Treviso” hoặc “phiên bản hiện đại”; xử lý an toàn trứng sống |
| Flan | King Arthur Baking | Giữ có điều kiện | Ghi cỡ khuôn/cốc, mức nước cách thủy và dấu hiệu chín |
| Mousse chocolate/dâu | Valrhona | Chưa xuất bản | Tách thành công thức riêng; loại bỏ thành phần tùy chọn mâu thuẫn; xử lý trứng sống |
| Bánh mì sữa Hokkaido | King Arthur Baking | Chưa xuất bản | Dùng công thức tangzhong thực sự hoặc đổi tên thành bánh mì sữa mềm |
| Croissant | King Arthur Baking | Chưa xuất bản | Bổ sung khối bơ cán, số lần gấp, thời gian nghỉ và nhiệt độ theo giai đoạn |
...
### 7. Tiramisu — chưa xuất bản

Công thức Le Beccherie công bố gồm lòng đỏ trứng, đường, mascarpone, bánh ladyfinger, cà phê và cocoa. Công thức này không có whipping cream, cream cheese, rượu rum hay lòng trắng trứng.[^8] Bản Bếp Đủ Bánh hiện là một biến thể hiện đại. Biến thể đó không sai chỉ vì khác nguyên bản, nhưng phải được gọi đúng.

Có hai hướng hợp lệ: “Tiramesù theo bản Le Beccherie” hoặc “Tiramisu kem nhẹ kiểu Bếp Đủ Bánh”. Hướng thứ nhất có giá trị câu chuyện cao nhưng dùng trứng không nấu; hướng thứ hai dễ điều chỉnh cho người làm tại nhà và có thể dùng sản phẩm trứng đã thanh trùng. FDA khuyến nghị dùng trứng hoặc sản phẩm trứng đã thanh trùng cho món dùng trứng sống hoặc nấu chưa kỹ.[^13] Khuyến nghị cho bản đầu là phiên bản hiện đại an toàn hơn, đồng thời viết bài riêng về công thức Treviso.
...
### 9. Mousse chocolate và mousse dâu — chưa xuất bản
...
### 10. Bánh mì sữa Hokkaido — chưa xuất bản
...
Đây là mâu thuẫn giữa tên, câu chuyện và cách làm. Nếu giữ tên Hokkaido/Japanese milk bread, cần dùng một công thức tangzhong thật sự và thử kết cấu sau 24–48 giờ. Nếu muốn giữ công thức hiện tại, nên đổi tên trung tính thành “bánh mì sữa mềm” và bỏ câu chuyện gắn với tangzhong.

### 11. Croissant — chưa xuất bản
...
PappaRoti là tên thương hiệu và trang chính thức mô tả sản phẩm đặc trưng của họ là bánh phủ cà phê–caramel.[^15] Trang này không công bố công thức chi tiết để dùng làm chuẩn. Vì vậy, Bếp Đủ Bánh không nên đặt tên công thức là “Papparoti” hoặc ngụ ý đó là công thức của thương hiệu.

Tên đề xuất là **Bánh mì cà phê nhân bơ**. Công thức phải được xem là bản chuyển thể của Bếp Đủ Bánh, có nguồn kỹ thuật tham khảo và biên bản thử lớp phủ. Câu chuyện món có thể giải thích đây là dòng coffee bun phổ biến, nhưng không được kể lịch sử thương hiệu khác như lịch sử của công thức do Bếp Đủ Bánh sở hữu.
...
Định lượng và sự kiện ẩm thực có thể được dùng làm cơ sở nghiên cứu, nhưng phần giới thiệu và hướng dẫn phải được Bếp Đủ Bánh viết lại bằng cấu trúc, ngôn ngữ và trải nghiệm riêng. Mỗi bản ghi cần lưu URL nguồn, ngày truy cập, người biên tập, trạng thái thử và ghi chú thay đổi. Không lấy ảnh từ các nguồn trên nếu chưa có giấy phép riêng.

### Ảnh tạo bằng AI chỉ là ảnh minh họa

Ảnh trong tài liệu Word không chứng minh kết quả của công thức. Nếu dùng trong bản phát triển, giao diện hoặc metadata phải ghi là ảnh minh họa; khi công thức đạt trạng thái đã thử nên ưu tiên ảnh của chính mẻ thử.

## Quy trình đưa một công thức lên website
...
6. Viết bước làm nguyên bản cho Bếp Đủ Bánh, kèm dấu hiệu nhận biết và cách xử lý lỗi thường gặp.
7. Ánh xạ với biến thể sản phẩm; kiểm tra gợi ý gói và lượng dư ở khẩu phần nhỏ, gốc và lớn.
8. Chỉ sau đó đổi trạng thái thành “đã kiểm chứng” và cho phép tạo giỏ từ công thức.
...
3. **Bánh mì sữa tangzhong:** kiểm tra thời gian chờ/ủ và mô hình bước làm nhiều giai đoạn.

Croissant nên để sau cùng vì đòi hỏi kỹ thuật cán lớp, điều kiện nhiệt độ và mô hình thời gian phức tạp nhất. Tiramisu và mousse chỉ nên mở lại sau khi đã chốt chính sách trứng thanh trùng.

## Quyết định còn mở

1. Tiramisu bản đầu sẽ là bản nguyên gốc Le Beccherie hay bản hiện đại dùng nguyên liệu an toàn hơn?
2. Giữ tên bánh mì sữa Hokkaido và chuyển sang tangzhong, hay giữ công thức hiện tại rồi đổi tên thành bánh mì sữa mềm?
3. Có chấp nhận ẩn các công thức chưa kiểm chứng khỏi danh mục công khai, hay vẫn hiển thị với nhãn “đang thử nghiệm” nhưng vô hiệu hóa tạo giỏ?
4. Chủ dự án sẽ tự thử bếp hay cần mời một người có kinh nghiệm làm bánh cùng xác nhận?
